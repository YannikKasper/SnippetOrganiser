...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.textDescription.setGeometry(QtCore.QRect(690, 330, 411, 321))
        ...
        self.textFolder = QtWidgets.QComboBox(Dialog)
        self.textFolder.setGeometry(QtCore.QRect(690, 251, 411, 31))
        self.textFolder.setEditable(True)
        self.textFolder.setMaxVisibleItems(20)
