...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEditSnippet.setGeometry(QtCore.QRect(540, 240, 641, 451))
        self.textEditSnippet.setObjectName("textEditSnippet")
        self.languageList = QtWidgets.QListWidget(self.centralwidget)
        self.languageList.setGeometry(QtCore.QRect(10, 90, 141, 601))
        ...
        self.label_2.setGeometry(QtCore.QRect(540, 200, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.folderList.setGeometry(QtCore.QRect(160, 90, 171, 601))
        self.folderList.setObjectName("folderList")
        self.snippetList = QtWidgets.QListWidget(self.centralwidget)
        self.snippetList.setGeometry(QtCore.QRect(340, 90, 171, 601))
        ...
        self.clipButton.setGeometry(QtCore.QRect(1140, 200, 41, 23))
        self.clipButton.setObjectName("clipButton")
        self.textDescription = QtWidgets.QTextEdit(self.centralwidget)
        self.textDescription.setGeometry(QtCore.QRect(540, 70, 641, 111))
        self.textDescription.setObjectName("textDescription")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(540, 30, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.btnDelete.setGeometry(QtCore.QRect(480, 30, 31, 31))
        self.btnDelete.setObjectName("btnDelete")
        self.btnBack = QtWidgets.QPushButton(self.centralwidget)
        self.btnBack.setGeometry(QtCore.QRect(120, 60, 31, 31))
